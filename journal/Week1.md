...
- [Fixing Tags](#fixing-tags)
    + [Locally delete a tag](#locally-delete-a-tag)
    + [Remotely delete a tag](#remotely-delete-a-tag)
    + [Checkout the commit that you want ot retag.](#checkout-the-commit-that-you-want-ot-retag)
...
For each allows us to enumerate over comples data types

```sh
[for s in var.list : upper(s)]
```

this is mostly useful when you are creating multiples of a cloud resource and you waqnt to reduce the amount of repetive terraform code.
